...
public class ArtsFrame extends JFrame {
	...
	public ArtsFrame() {
		...
		JLabel lblArtsGroup = new JLabel("Arts Group");
		lblArtsGroup.setHorizontalAlignment(SwingConstants.CENTER);
		lblArtsGroup.setForeground(new Color(72, 61, 139));
		lblArtsGroup.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblArtsGroup.setBounds(345, 25, 424, 25);
		panel_1.add(lblArtsGroup);
		...
		radioButton_1.setBounds(696, 57, 109, 23);
