...
public class PreEngineeringFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PreEngineeringFrame frame = new PreEngineeringFrame();
	...
	//	setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		JLabel lblPreEngineeringGroup = new JLabel("Pre Engineering Group");
		lblPreEngineeringGroup.setHorizontalAlignment(SwingConstants.CENTER);
		lblPreEngineeringGroup.setForeground(new Color(72, 61, 139));
		lblPreEngineeringGroup.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblPreEngineeringGroup.setBounds(345, 25, 424, 25);
		panel_1.add(lblPreEngineeringGroup);
		...
		radioButton_1.setBounds(699, 57, 109, 23);
