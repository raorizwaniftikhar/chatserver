...
public class IcsFrame extends JFrame {
	...
	//	setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		JLabel lblIcsGroup = new JLabel("Ics Group");
		lblIcsGroup.setHorizontalAlignment(SwingConstants.CENTER);
		lblIcsGroup.setForeground(new Color(72, 61, 139));
		lblIcsGroup.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblIcsGroup.setBounds(345, 25, 424, 25);
		panel_1.add(lblIcsGroup);
		...
		radioButton_1.setBounds(693, 57, 109, 23);
