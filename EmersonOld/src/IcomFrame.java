...
public class IcomFrame extends JFrame {
	...
	public IcomFrame() {
		...
		JLabel lblIcomGroup = new JLabel("I.Com Group");
		lblIcomGroup.setHorizontalAlignment(SwingConstants.CENTER);
		lblIcomGroup.setForeground(new Color(72, 61, 139));
		lblIcomGroup.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblIcomGroup.setBounds(345, 25, 424, 25);
		panel_1.add(lblIcomGroup);
		...
		radioButton_1.setBounds(695, 57, 109, 23);
